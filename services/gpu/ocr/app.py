...
async def read():
    if request.method == 'POST':
        ...
        for mitta_uri in mitta_uris:
            log_line = f"Received POST request to /read with: '{mitta_uri}'. Responding with texts."
        ...
        return jsonify({"texts": all_recognized_text, "coords": all_coordinates})
